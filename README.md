...
配置接口接收数据，将数据通过http发送给其他服务，轻量级，无其他依赖，独立jar部署。

**Github:** https://github.com/tuituidan/msg-gateway

**Gitee:** https://gitee.com/tuituidan/msg-gateway
...
通过常规maven命令构建，无其他依赖服务，仅需要jdk环境即可启动。
